...
Once we make the changes, we cannot see the or revert it back to the original data anymore.
...
- Understand the data itself **(We will explore easy to learn concepts like Distributions, Skewness, Frequency)**
